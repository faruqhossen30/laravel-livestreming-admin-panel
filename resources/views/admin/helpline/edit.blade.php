        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('gift.update', $gift->id) }}" method="POST" class="forms-sample">
                        @method('PUT')
                        @csrf
                        <div class="mb-3">
                            <label for="exampleInputname1" class="form-label">Gift Name</label>
                            <input type="text" name="name" value="{{$gift->name}}" class="form-control" id="exampleInputname1"
                                autocomplete="off" placeholder="Heart">
                        </div>
                        <div class="mb-3">
                            <label for="diamond" class="form-label">Diamond</label>
                            <input name="diamond" type="number" value="{{$gift->diamond}}" class="form-control @error('diamond') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            ...
                            <input name="commission" type="number" value="{{$gift->commission}}" class="form-control @error('commission') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            ...
                            <input name="img_url" type="text" value="{{$gift->img_url}}" class="form-control @error('img_url') is-invalid @enderror"
