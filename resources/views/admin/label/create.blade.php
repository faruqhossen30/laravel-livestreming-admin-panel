        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('label.store') }}" method="POST" class="forms-sample">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="label" type="text" value="{{old('label')}}" class="form-control  @error('label') is-invalid @enderror"
